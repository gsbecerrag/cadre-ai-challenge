...
# Task 22: Research Agent and the Lead Brief

Source ticket: `.scratch/cadre-support-agent/issues/22-research-agent-and-lead-brief.md` — read it first; it is your requirements. Then read the spec's Testing Decisions, CONTEXT.md, and the ADRs this area touches.
...
# Task 23: "Research this Lead" on the Console

Source ticket: `.scratch/cadre-support-agent/issues/23-console-research-this-lead.md` — read it first; it is your requirements. Then read the spec's Testing Decisions, CONTEXT.md, and the ADRs this area touches.
